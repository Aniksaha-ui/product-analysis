    ...
    <div className="container mt-5">
      <div className="row g-4">
        ...
        <div className="col-12">
          <div class="card">
            <div class="card-body bg-primary text-white">
              <h5 class="card-title">What is semantic Tags?</h5>
              <p class="card-text">
                A sementic tag describe the meaning of the element.In Html 4,
                there was no sementic tags.We defined it like (div
                class="header"/>).But in Html 5,there is a tag named header.So
                it is very effective for a programmer and also for the
